<template>
  <div class='content-body' v-once>
    ...
    <div>
      <p><em>We are committed to protecting and respecting your privacy.</em></p>
      <p>This policy (together with our <Link to='/legal/terms'>Terms of Use</Link> and any other documents referred to on it) sets out the basis on which any personal data we collect from you, or that you provide to us, will be processed by us. Please read the following carefully to understand our views and practices regarding your personal data and how we will treat it. By visiting Betacle.com ('our website') you are accepting and consenting to the practices described in this policy.<br />The definitions contained in our <Link to='/legal/terls'>Terms of Use</Link> apply to this policy.</p>
      <h2 class='legal-head'>Information we may collect from you</h2>
      <p>
        We may collect and process the following data about you:
        <dl>
          <dt>Information you give us.</dt>
          <dd>You may give us information about you by filling in forms on our website or by corresponding with us by phone, e-mail or otherwise. This includes information you provide when you register to use our website, subscribe to our service or search for a product and when you report a problem with our website. This includes information you provide when you register to use our website, subscribe to our service, search for a product, enter a competition, promotion or survey, and when you report a problem with our website. If you give us information on behalf of someone else, you confirm that you have shared this policy with them and that they have given permission for us to use their information as set out in this policy.</dd>
          <dt>Information we collect about you.</dt>
          <dd>
          ...
          <dt>Information we receive from other sources.</dt>
          <dd>We may receive information about you if you use any of the other websites we operate or the other services we provide. In this case we will have informed you when we collected that data that it may be shared internally and combined with data collected on this site. We are also working closely with third parties (including, for example, business partners, sub-contractors in technical, payment and delivery services, advertising networks, analytics providers, search information providers, and credit reference agencies) and may receive information about you from them.</dd>
        </dl>
      </p>
      <h2 class='legal-head'>Cookies</h2>
      <p>Our website uses cookies to distinguish you from other users of our website. This helps us to provide you with a good experience when you browse our website and also allows us to improve our site. For detailed information on the cookies we use and the purposes for which we use them see our <Link to='/legal/cookies'>Cookie policy</Link>.</p>
      <h2 class='legal-head'>Uses made of the information</h2>
      ...
      <ul class='content-list'>
        ...
        <li>to provide you, or permit selected third parties to provide you, with information about the services we feel may interest you;</li>
      ...
      <h2 class='legal-head'>Disclosure of your information</h2>
      <p>We may share your personal information with any member of our group, which means our subsidiaries, and our ultimate holding company and its subsidiaries, as defined in section 1159 of the UK Companies Act 2006.</p>
      ...
      <ul class='content-list'>
        ...
        <li>If our website or substantially all of its assets are acquired by a third party, in which case personal data held by it about its customers will be one of the transferred assets.</li>
        <li>If we are under a duty to disclose or share your personal data in order to comply with any legal obligation, or in order to enforce or apply our website <Link to='/legal/terms'>Terms of Use</Link> or to protect the rights, property, or safety of Betacle, our customers, or others. This includes exchanging information with other companies and organisations for the purposes of fraud protection and credit risk reduction.</li>
      </ul>
      <h2 class='legal-head'>Where we store your personal data</h2>
      ...
      <h2 class='legal-head'>Your rights</h2>
      ...
      <h2 class='legal-head'>Changes to our privacy policy</h2>
      ...
      <p>To contact us in relation to this privacy policy, please email <a href='mailto:legal@betacle.com'>legal@betacle.com</a></p>
    </div>
  </div>
</template>
